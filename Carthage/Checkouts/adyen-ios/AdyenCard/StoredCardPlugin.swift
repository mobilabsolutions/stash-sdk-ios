...
internal final class StoredCardPlugin: CardPlugin {
    ...
    internal override func viewController(for _: [PaymentDetail], appearance: Appearance, completion: @escaping Completion<[PaymentDetail]>) -> UIViewController {
    ...
    internal func finish(with _: Result<PaymentResult>, completion: @escaping () -> Void) {
...
extension StoredCardPlugin {
    private final class AlertManager: NSObject, UITextFieldDelegate {
        ...
        private func submit() {
            ...
            self.submit(securityCode: securityCode)
        }
        ...
        private func submit(securityCode: String) {
            ...
            self.completionHandler?(details)
        }
        ...
        internal func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
            ...
            if isDeleting {
                ...
                if shouldDisable {
                    self.payAction.isEnabled = false
                }
                return true
            }
