...
public final class PaymentController {
    ...
    private func decode(paymentSessionResponse: String) {
        do {
            ...
            self.requestPaymentMethodSelection()
        } catch {
    ...
    private func performIdentification(with details: PaymentInitiationResponse.Details, for request: PaymentInitiationRequest) {
        ...
        self.requestAdditionalDetails(identificationDetails, for: request, paymentData: details.paymentData, returnData: details.returnData)
    }
    ...
    private func performChallenge(with details: PaymentInitiationResponse.Details, for request: PaymentInitiationRequest) {
        ...
        self.requestAdditionalDetails(challengeDetails, for: request, paymentData: details.paymentData, returnData: details.returnData)
    }
