...
internal final class DynamicHeightPresentationController: UIPresentationController {
    ...
    override func presentationTransitionWillBegin() {
        ...
        self.animateAlongsideTransition {
    ...
    internal override var frameOfPresentedViewInContainerView: CGRect {
        var contentSize = self.containerViewBounds.size
        ...
        presentedFrame.origin.y = self.containerViewBounds.maxY - presentedFrame.height
