...
internal final class ApplePayPlugin: NSObject, PaymentDetailsPlugin {
    ...
    internal func viewController(for _: [PaymentDetail], appearance _: Appearance, completion: @escaping Completion<[PaymentDetail]>) -> UIViewController {
        self.paymentDetailCompletion = completion
        if let newPaymentAuthorizationViewController = newPaymentAuthorizationViewController() {
            self.paymentAuthorizationViewController = newPaymentAuthorizationViewController
    ...
    internal func finish(with result: Result<PaymentResult>, completion: @escaping () -> Void) {
        ...
        self.paymentAuthorizationCompletion?(authorizationStatus)
