...
class CheckoutStatusViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.checkoutStepImageView.translatesAutoresizingMaskIntoConstraints = false
        self.checkoutStepImageView.backgroundColor = UIColor.clear
        self.checkoutStepImageView.contentMode = .top
        view.addSubview(self.checkoutStepImageView)

        self.nextStepButton.translatesAutoresizingMaskIntoConstraints = false
        view.addSubview(self.nextStepButton)
