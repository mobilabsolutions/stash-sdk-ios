...
class BTAppSwitch_Tests: XCTestCase {
    ...
    override func setUp() {
        super.setUp()
        self.appSwitch = BTAppSwitch.sharedInstance()
    }
    ...
    func testHandleOpenURL_whenHandlerIsRegistered_invokesCanHandleAppSwitchReturnURL() {
        self.appSwitch.register(MockAppSwitchHandler.self)
...
class MockAppSwitchHandler: BTAppSwitchHandler {
    ...
    static var lastCanHandleSourceApplication: String?
    static var lastHandleAppSwitchReturnURL: URL?

    @objc static func canHandleAppSwitchReturn(_ url: URL, sourceApplication: String) -> Bool {
        self.lastCanHandleURL = url
        self.lastCanHandleSourceApplication = sourceApplication
        return self.cannedCanHandle
    }

    @objc static func handleAppSwitchReturn(_ url: URL) {
        self.lastHandleAppSwitchReturnURL = url
    }
}
