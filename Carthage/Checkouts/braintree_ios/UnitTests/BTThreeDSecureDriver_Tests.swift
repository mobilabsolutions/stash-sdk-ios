...
class BTThreeDSecureDriver_Tests: XCTestCase {
    ...
    override func setUp() {
        ...
        self.mockAPIClient = MockAPIClient(authorization: "development_client_key")!
    }
    ...
    func testVerification_whenAPIClientIsNil_callsBackWithError() {
        ...
        threeDSecureDriver.verifyCard(withNonce: self.originalNonce_lookupEnrolledAuthenticationNotRequired, amount: NSDecimalNumber.one, completion: { (tokenizedCard, error) -> Void in
    ...
    func testVerification_whenRemoteConfigurationFetchFails_callsBackWithConfigurationError() {
        ...
        threeDSecureDriver.verifyCard(withNonce: self.originalNonce_lookupEnrolledAuthenticationNotRequired, amount: NSDecimalNumber.one, completion: { (_, error) -> Void in
    ...
    func testVerification_withCardThatRequiresAuthentication_requestsPresentationOfViewController() {
        ...
        threeDSecureDriver.verifyCard(withNonce: self.originalNonce_lookupEnrolledAuthenticationRequired, amount: NSDecimalNumber.one) { (_, _) -> Void in }
    ...
    func testVerification_whenCardIsNotEnrolled_returnsCardWithNewNonceAndCorrectLiabilityShiftInformation() {
        ...
        threeDSecureDriver.verifyCard(withNonce: self.originalNonce_lookupCardNotEnrolled, amount: NSDecimalNumber.one) { (tokenizedCard, error) -> Void in
    ...
    func testError_whenFinishIsCalledMoreThanOnce_sendsErrorAnalyticsEvent() {
        ...
        XCTAssertEqual(self.mockAPIClient.postedAnalyticsEvents.last!, "ios.threedsecure.error.finished-without-handler")
    }
}
