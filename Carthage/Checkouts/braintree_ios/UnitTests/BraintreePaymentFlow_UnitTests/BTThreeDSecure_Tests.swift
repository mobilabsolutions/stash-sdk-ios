...
class BTThreeDSecure_UnitTests: XCTestCase {
    ...
    override func setUp() {
        ...
        self.threeDSecureRequest = BTThreeDSecureRequest()
        self.threeDSecureRequest.amount = 10.0
        self.threeDSecureRequest.nonce = "fake-card-nonce"
    ...
    func testLookupThreeDSecure_whenRemoteConfigurationFetchFails_callsBackWithConfigurationError() {
        ...
        driver.performThreeDSecureLookup(self.threeDSecureRequest) { _, error in
    ...
    func testLookupThreeDSecure_sendsAllParameters() {
        ...
        self.threeDSecureRequest.amount = 9.97
        self.threeDSecureRequest.nonce = "fake-card-nonce"
        self.threeDSecureRequest.mobilePhoneNumber = "5151234321"
        self.threeDSecureRequest.email = "tester@example.com"
        self.threeDSecureRequest.shippingMethod = "03"
        ...
        self.threeDSecureRequest.billingAddress = billingAddress

        driver.performThreeDSecureLookup(self.threeDSecureRequest) { _, _ in
    ...
    func testLookupThreeDSecure_withCardThatDoesntRequireAuthentication_callsCompletionWithACard() {
        ...
        driver.performThreeDSecureLookup(self.threeDSecureRequest) { lookup, error in
    ...
    func testLookupThreeDSecure_withCardThatRequiresAuthentication_lookupResultRequiresAuthentication() {
        ...
        driver.performThreeDSecureLookup(self.threeDSecureRequest) { lookup, _ in
    ...
    func testStartPayment_displaysSafariViewControllerWhenAvailable_andRequiresAuthentication() {
        ...
        driver.startPaymentFlow(self.threeDSecureRequest) { _, _ in
        }
    ...
    func testStartPayment_doesNotDisplaySafariViewControllerWhenAuthenticationNotRequired() {
        ...
        driver.startPaymentFlow(self.threeDSecureRequest) { result, error in
    ...
    func testStartPayment_success_sendsAnalyticsEvents() {
        ...
        waitForExpectations(timeout: 4, handler: nil)
        XCTAssertTrue(self.mockAPIClient.postedAnalyticsEvents.contains("ios.three-d-secure.start-payment.selected"))
        XCTAssertTrue(self.mockAPIClient.postedAnalyticsEvents.contains("ios.three-d-secure.webswitch.initiate.succeeded"))
    }
    ...
    func testStartPayment_failure_sendsAnalyticsEvents() {
        ...
        driver.startPaymentFlow(self.threeDSecureRequest) { _, error in
        ...
        waitForExpectations(timeout: 4, handler: nil)
        XCTAssertTrue(self.mockAPIClient.postedAnalyticsEvents.contains("ios.three-d-secure.start-payment.selected"))
        XCTAssertTrue(self.mockAPIClient.postedAnalyticsEvents.contains("ios.three-d-secure.start-payment.failed"))
    }
