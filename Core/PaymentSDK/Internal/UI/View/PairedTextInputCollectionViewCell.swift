...
class PairedTextInputCollectionViewCell: UICollectionViewCell, NextCellEnabled {
    ...
    private var firstErrorText: String? {
        didSet {
            ...
            self.errorLabel.text = firstErrorText
    ...
    private var secondErrorText: String? {
        didSet {
            ...
            self.errorLabel.text = secondErrorText
...
//        self.firstErrorText = "This is first error"
       ...
       // self.secondErrorText = "This is second error"
        ...
        self.errorLabel.text = (firstErrorText.flatMap({ $0 + "\n" }) ?? "") + (secondErrorText ?? "")
        self.errorLabelZeroHeightConstraint?.isActive = firstErrorText == nil && secondErrorText == nil
    }
